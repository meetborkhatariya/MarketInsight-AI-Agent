...
if generate and query_text:
    ...
    if data and data.get("success"):
        ...
        with tabs[0]:
            ...
            _download_button("report.md", report)

        with tabs[1]:
            st.markdown(analysis or "*No analysis available.*")
            _download_button("market_analysis.md", analysis)

        with tabs[2]:
            st.markdown(insights or "*No insights available.*")
            _download_button("insights.md", insights)

        with tabs[3]:
            st.markdown(recommendations or "*No recommendations available.*")
            _download_button("recommendations.md", recommendations)
